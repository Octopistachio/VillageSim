///@description Load the main map from the file, and call the other maps from it
...
global.inventory_ds_map = ds_map_find_value(global.level_ds_map, "inventory"); //Load the inventory map from level