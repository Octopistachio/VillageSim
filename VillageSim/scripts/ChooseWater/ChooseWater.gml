...
var waterBorder_min = 2; //Min number of water tiles along the edge
var waterBorder_max = 6; //Max number of water tiles along the edge
var waterBorder = random_range(waterBorder_min, waterBorder_max); //Randomly pick a number of water tiles
