...
if(global.paused) { //This means the large inventory is open
	...
	var x1 = invBorder_x;
	var y1 = display_get_gui_height() - inv_height - invBorder_y;
	var x2 = display_get_gui_width() - invBorder_x;
	var y2 = display_get_gui_height() - invBorder_y;

	if point_in_rectangle(window_mouse_get_x(),window_mouse_get_y(),x1,y1,x2,y2) { //If the mouse is inside the hotbar
		
		for(var i = 0; i <= oInventory.inventorySlots; i++) {
